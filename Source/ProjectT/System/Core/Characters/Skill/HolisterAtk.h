...
#include "CoreSkill.h"
#include "HolisterAtk.generated.h"

UCLASS()
class PROJECTT_API AHolisterAtk : public ACoreSkill
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<USceneComponent> HolisterAtkRootSceneComponent;

	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TObjectPtr<class UBoxComponent> HolisterAtkCollisionComponent;
	
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TObjectPtr<class UNiagaraComponent> HolisterAtkFXComponent;
};
